...
export default {
  ...
  computed: {
    ...
    selectedSubType() {
      return this.subType ? this.subTypes.find((s) => s.id === this.subType) : {};
    },
 ...
 */
    initializeType() {
      ...
      //   console.log('*** setting subtype to ', this.$route.query[SUB_TYPE]);
...
<template>
  ...
  >
    ...
    />
    <template v-else-if="subType && selectedSubType">
